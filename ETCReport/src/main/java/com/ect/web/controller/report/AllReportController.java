...
public class AllReportController extends BaseFormReportController {
    ...
    public void search() {
        ...
        final Integer count = reportService.countReportByCriteria(reportCriteria);
        ...
        if (count != null || count > 0) {
            ...
            LazyViewFormReportImpl reportModel = new LazyViewFormReportImpl();
    ...
    public void fileXLSDownload(ViewReportStatus viewReportStatus) {
        ...
        switch (viewReportStatus.getReportCode()) {
            case REPORT_001:

...
@ManagedBean
@ViewScoped
public class Report012SummaryController extends BaseFormReportController {
    
    private static final long serialVersionUID = 7267052556829828496L;
    
    private static final Logger logger = LoggerFactory.getLogger(Report012SummaryController.class);
    ...
    public void search() {
        ...
        viewReportResult = reportService.findReportExpression012ByCriteria(reportCriteria);
     ...
     */
    public List<ViewReportExpression> getViewReportResult() {
     ...
     */
    public void setViewReportResult(List<ViewReportExpression> viewReportResult) {
    ...
    public void fileXLSDownload() {
        ...
        String reportName = REPORT_EXPRESSION_012;
    ...
    private ViewReportExpression getSum() {
        ViewReportExpression sumDetail = new ViewReportExpression();

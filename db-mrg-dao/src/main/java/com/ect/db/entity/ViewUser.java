...
public class ViewUser extends DomainEntity{
    ...
    public int hashCode() {
        ...
        hash = 79 * hash + (this.provinceId != null ? this.provinceId.hashCode() : 0);
    ...
    public boolean equals(Object obj) {
        ...
        if (this.provinceId != other.provinceId && (this.provinceId == null || !this.provinceId.equals(other.provinceId))) {
            return false;
        }

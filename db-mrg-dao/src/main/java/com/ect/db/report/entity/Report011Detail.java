 ...
 */
@Entity
@Table(name = "REPORT_011_DETAIL")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Report011Detail.findAll", query = "SELECT r FROM Report011Detail r")})
public class Report011Detail extends DomainEntity implements Serializable {
    ...
    @ManyToOne
    private Report011 reportId;

    public Report011Detail() {
    }

    public Report011Detail(Integer reportDetailId) {
    ...
    public Report011 getReportId() {
        return reportId;
    }

    public void setReportId(Report011 reportId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Report011Detail)) {
            return false;
        }
        Report011Detail other = (Report011Detail) object;
    ...
    public String toString() {
        return "Report011Detail{" + "reportDetailId=" + reportDetailId + ", institution=" + institution + ", allamount=" + allamount + ", atCenter=" + atCenter + ", atEctProvince=" + atEctProvince + ", ectResolve=" + ectResolve + ", analystRemain=" + analystRemain + ", offerEct=" + offerEct + ", accessCommittee=" + accessCommittee + ", onAgenda=" + onAgenda + '}';
    }
